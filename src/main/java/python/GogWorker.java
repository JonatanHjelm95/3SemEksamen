 ...
 * @author jonab
 */
public class GogWorker implements Runnable {

    String command;
    String url;
    long runTimeSeconds;

    public GogWorker(String url, long runtime) {
        this.command = "python C:\\Users\\jonab\\.ssh\\3Sem\\Genbrugsen\\webscraper\\gogWebscraper.py ";
        this.url = url;
